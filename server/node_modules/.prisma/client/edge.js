...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\fullstack realestate\\server\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\fullstack realestate\\server\\prisma\\schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
    "schemaEnvPath": "../../../.env"
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id               String      @id @default(auto()) @map(\"_id\") @db.ObjectId\n  name             String?\n  email            String      @unique\n  image            String?\n  bookedVisits     Json[]\n  favResidenciesID String[]    @db.ObjectId\n  Residencies      Residency[] @relation(\"UserResidencies\")\n  ownedResidencies Residency[] @relation(\"Owner\")\n}\n\nmodel Residency {\n  id          String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  title       String\n  description String\n  price       Int\n  address     String\n  city        String\n  country     String\n  image       String\n  facilities  Json\n  userEmail   String\n  owner       User     @relation(\"Owner\", fields: [userEmail], references: [email])\n  user        User     @relation(\"UserResidencies\", fields: [userEmail], references: [email])\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n\n  @@unique(fields: [address, userEmail])\n}\n",
  "inlineSchemaHash": "0bb316f52268c3151d7dbc407d9ed835a73f44bcfea9508820b24658573f7387",
  "copyEngine": true
}
config.dirname = '/'
